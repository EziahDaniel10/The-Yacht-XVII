...
export function Footer() {
  return (
    <footer className="bg-[#0A192F] text-white pt-20 pb-10">
      <div className="container-wide grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-24 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-4 text-white/60">
            <li><a href="mailto:concierge@yachtxvii.com" className="hover:text-white transition-colors">concierge@yachtxvii.com</a></li>
      ...
      <div className="container-wide border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-white/40 uppercase tracking-wider">
